            ...
            <div class="card-body">
                <form>
                    <div class="form-group row ">
                        ...
                        <div class="col-sm-6">
                            <input type="date" class="form-control form-control-sm" name="tanggal" id="tanggal" value="{{$surat->tanggal}}" readonly>
                        </div>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="NomorSurat" class="form-control" value="{{$surat->NomorSurat}}" readonly>
                                <div class="text-danger">
                                    @error('NomorSurat')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <iframe class="col-sm-12 mx-auto" src="{{url('folder_surat/'.$surat->surat)}}" width="150px" height="150px">
                            </iframe>
                        </div>
                            <br>
