...
@section('isicontent')
    ...
    <form action="/surat/tambah" method="POST" enctype="multipart/form-data"  onsubmit="return confirm('Pastikan Data Yang diarsipkan sudah benar')">
        @csrf 
        <div class="card col-sm-10 mx-auto">
            <div class="card-header bg-info">
                ...
                <div align="right">
                <a href="/surat" class="badge bg-gradient-warning">arsip surat</a>
                </div>
            </div>
            <div class="card-body">
                <form>
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="NamaSurat" class="form-control" rows="4" placeholder="Enter ...">
                                <div class="text-danger">
                                    @error('NamaSurat')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="pengirim" class="form-control" rows="4" placeholder="Enter ...">
                                <div class="text-danger">
                                    @error('pengirim')
                                        {{ $message }}
                                    @enderror
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-6">
                            <input type="text" name="tujuan" class="form-control" rows="4" placeholder="Enter ...">
                                <div class="text-danger">
                                    @error('tujuan')
                                        {{ $message }}
                                    @enderror
